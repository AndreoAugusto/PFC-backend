...
public class Cliente {
    ...
    @Size(max = 100, message = "Nome deve conter 100 caracteres maximo")
    ...
    public Cliente(int id_cliente, String nome_cli, String cpf_cli, String telefone_cli, String email_cli) {
