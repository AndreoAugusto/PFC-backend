...
public class FornecedorResource {
    ...
    public ResponseEntity<List<FornecedorDTO>> findAll()    {
        ...
        List<FornecedorDTO> dtoList = list.stream().map(obj -> service.toNewDTO(obj)).collect(Collectors.toList());
    ...
    public ResponseEntity<Void> insert(@Valid @RequestBody FornecedorDTO objDto)    {
        ...
        URI uri = ServletUriComponentsBuilder.fromCurrentRequest().path("/{di}").buildAndExpand(obj.getForId()).toUri();
